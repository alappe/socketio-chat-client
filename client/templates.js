(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body class="chat"><div class="contain-to-grid sticky"><nav data-topbar="data-topbar" role="navigation" class="top-bar"><ul class="title-area"><li class="name"><h1><a id="welcome">Chat</a></h1></li></ul></nav></div><div id="alerts"></div><main data-hook="page-container"><div class="row"><div id="messages" class="large-12 columns"></div></div><form class="message-input"><input type="text" value="" placeholder="your message…"/></form></main></body>';
    };
    ...
    // includes/alert.jade compiled template
    templatizer["includes"]["alert"] = function tmpl_includes_alert() {
        return '<div class="alert-box info row"><div class="large-12 columns"><span data-hook="message"></span><a href="#" class="close">&times;</a></div></div>';
    };

    // includes/message.jade compiled template
    templatizer["includes"]["message"] = function tmpl_includes_message() {
        return '<div data-hook="twitter" class="msg"><div data-alert="data-alert" class="alert-box secondary"><span data-hook="date" class="time"></span><span data-hook="name" class="name"></span><span data-hook="content" class="content"></span></div></div>';
    };
